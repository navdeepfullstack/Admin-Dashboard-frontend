          ...
          <div className="col-md-6">
            <Form.Group className="mb-3">
              ...
              {formik.errors.product_name && formik.touched.product_name && (
                <div style={{ color: "red" }} className="validation" >{formik.errors.product_name}</div>
              )}
            </Form.Group>
          </div>
          <div className="col-md-6">
            <Form.Group className="mb-3">
              ...
              {formik.errors.images && formik.touched.images && (
                <div style={{ color: "red" }} className="validation" >{formik.errors.images}</div>
              )}
            </Form.Group>
          </div>
          <div className="col-md-6">
            <Form.Group className="mb-3">
              ...
              {formik.errors.colors && formik.touched.colors && (
                <div style={{ color: "red" }} className="validation" >{formik.errors.colors}</div>
              )}
            </Form.Group>
          </div>
          <div className="col-md-6">
            <Form.Group className="mb-3">
              ...
              {formik.errors.tags && formik.touched.tags && (
                <div style={{ color: "red" }} className="validation" >{formik.errors.tags}</div>
              )}
            </Form.Group>
          </div>
          <div className="col-md-6">
            <Form.Group className="mb-3">
              ...
              {formik.errors.price && formik.touched.price && (
                <div style={{ color: "red" }} className="validation" >{formik.errors.price}</div>
              )}
            </Form.Group>
          </div>
          <div className="col-md-6">
            <Form.Group className="mb-3">
              ...
              {formik.errors.category && formik.touched.category && (
                <div style={{ color: "red" }} className="validation" >{formik.errors.category}</div>
              )}
            </Form.Group>
          </div>
